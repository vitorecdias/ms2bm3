...
const br = require('react-intl/locale-data/br');
addLocaleData([...en, ...it, ...fr, ...de, ...es, ...nl, ...zh, ...hr, ...pt,...br]);
...
const LocaleUtils = {
    ensureIntl(callback) {
        require.ensure(['intl', 'intl/locale-data/jsonp/en.js', 'intl/locale-data/jsonp/it.js', 'intl/locale-data/jsonp/fr.js', 'intl/locale-data/jsonp/de.js', 'intl/locale-data/jsonp/es.js', 'intl/locale-data/jsonp/nl.js', 'intl/locale-data/jsonp/zh.js', 'intl/locale-data/jsonp/hr.js', 'intl/locale-data/jsonp/br.js'], (require) => {
    ...
    getLocale: function(query = {}) {
        ...
        const defaultLocale = supportedLocales.br ? { key: 'br', locale: supportedLocales.br } : { key, locale: supportedLocales[key] };
