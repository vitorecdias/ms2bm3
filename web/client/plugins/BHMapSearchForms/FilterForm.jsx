...
class FilterForm extends React.Component {
    ...
    handleSubmit (){       
        ...
        console.log(this.props.camadasList[this.state.valueCamada].servicos.wfs.typename+" "+this.attr.value+" "+this.state.valueOperador+" "+String(this.state.valor).toLowerCase())
